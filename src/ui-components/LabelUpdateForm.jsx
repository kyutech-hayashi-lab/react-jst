...
export default function LabelUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...labelRecord };
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Label, id) : label;
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          const original = await DataStore.query(Label, id);
          await DataStore.save(
            Label.copyOf(original, (updated) => {
